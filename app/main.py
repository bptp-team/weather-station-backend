...
from app.services.historical_readings import HistoricalReadingsService
...
def _create_historical_repository(settings: Settings) -> HistoricalInfluxRepository:
    ...
    *,
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            historical_close = getattr(historical_repository, "close", None)

            if historical_close is not None:
                await asyncio.to_thread(historical_close)
